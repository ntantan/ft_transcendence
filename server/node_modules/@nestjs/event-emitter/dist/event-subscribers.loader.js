...
let EventSubscribersLoader = class EventSubscribersLoader {
    ...
    getRegisterListenerMethodBasedOn(options) {
        return Boolean(options === null || options === void 0 ? void 0 : options.prependListener)
    ...
    registerRequestScopedListener(eventListenerContext) {
        ...
        listenerMethod(event, (...args) => __awaiter(this, void 0, void 0, function* () {
            const contextId = core_1.ContextIdFactory.create();
            this.registerEventPayloadByContextId(args, contextId);
            const contextInstance = yield this.injector.loadPerContext(eventListenerInstance, moduleRef, moduleRef.providers, contextId);
